...
com2<-combn(salary,2) #연봉데이터에서 2개씩 선택해서 데이터로 생성, com2에 생성
print(com2)
...
print(meanofz5)
barplot(table(z5),xlab="평균5",ylab="도수", main="표본크기5의 도수분포표")
...
library(sampling)
sam2=strata(data=iris,stratanames<-c("Species"),size<-c(3,3,3),method='srswor') #iris 데이터 사용하여 표본추출, Species층을 기준으로
